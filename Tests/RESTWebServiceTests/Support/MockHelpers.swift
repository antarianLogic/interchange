...
extension Mock {
    ...
    init(url: URL, method: HTTPMethod = .get, jsonString: String, statusCode: Int = 200) {
        self.init(url: url, dataType: .json, statusCode: statusCode, data: [method : Data(jsonString.utf8)])
    }
